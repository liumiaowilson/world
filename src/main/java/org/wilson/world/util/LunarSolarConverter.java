...
public class LunarSolarConverter {
    ...
    public static String lunarYearToGanZhi(int lunarYear){
        final String[] tianGan = {"Jiǎ","Yǐ","Bǐng","Dīng","Wù","Jǐ","Gēng","Xīn","Rén","Guǐ"};
        final String[] diZhi = {"Zǐ","Chǒu","Yín","Mǎo","Chén","Sì","Wǔ","Wèi","Shēn","Yǒu","Xū","Hài"};
        return tianGan[(lunarYear-4) % 10]+diZhi[(lunarYear-4) % 12]+" Year";
    }
