...
import org.wilson.world.console.ObjectVisitor.Traversal;
...
public class ObjectExplorer {
     ...
     * particular:
     * <ul>
     * <li>If {@link Feature#VISIT_PRIMITIVES} is contained in features, the
     * visitor will also be notified about exploration of primitive values.
     ...
     *            return value at the end of the exploration
     * @param features
     *            a set of desired features that the object exploration should
     *            have
     * @return whatever value is returned by the visitor at the end of the
     *         traversal
     * @see ObjectVisitor
    ...
    static final Predicate<Chain>        notEnumFieldsOrClasses = new Predicate<Chain>() {
                                                                    public boolean apply(Chain chain) {
                                                                        return !(Enum.class
                                                                                .isAssignableFrom(chain.getValueType())
