...
public class MemoryMeasurer {
     ...
     * This should be subtracted for any enum value encountered, since it is
     * static in nature.
     */
     ...
     * through that, excluding static fields, {@code Class} objects, and fields
     * defined in {@code enum}s (all these are considered shared values, which
     ...
     *            explored (and treated as part of the object graph), or
    ...
    public static long measureBytes(Object rootObject, Predicate<Object> objectAcceptor) {
        ...
        Predicate<Chain> completePredicate = Predicates
                .and(ImmutableList.of(new ObjectExplorer.AtMostOncePredicate(), ObjectExplorer.notEnumFieldsOrClasses,
