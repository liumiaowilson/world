...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        %>
        <div class="checkbox">
            <label><input type="checkbox" value="<%=roleAttr.id%>"><%=roleAttr.name%></label>
        </div>
        <%
        }
        %>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/role/create"), { name: $('#name').val(), 'description': description, 'attrIds': ids.join(",") }, function(data) {
