<%
String page_title = "Reaction New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <textarea class="form-control" id="condition" rows="5" maxlength="200" placeholder="Enter condition"></textarea>
    </fieldset>
    <fieldset class="form-group">
        <label for="result">Result</label>
        <textarea class="form-control" id="result" rows="5" maxlength="200" placeholder="Enter result"></textarea>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/reaction/create"), { name: $('#name').val(), 'condition': condition, 'result': $('#result').val() }, function(data) {
