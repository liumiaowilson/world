<%
String page_title = "Expense Item New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="number" class="form-control" id="amount" maxlength="20" placeholder="Enter amount" required>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/expense_item/create"), { name: $('#name').val(), 'description': description, 'type': $('#type').val(), 'amount': $('#amount').val()}, function(data) {
