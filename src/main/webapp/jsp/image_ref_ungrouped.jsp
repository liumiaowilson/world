<%
String page_title = "Image Ref Ungrouped";
%>
...
<script>
            $(document).ready(function(){
                $.get(getAPIURL("api/image/list_ref_ungrouped"), function(data){
                            ...
                            columns: [
                                {
                                    ...
                                    fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                                        $(nTd).html("<a href=\"javascript:jumpTo('image_set_image.jsp?refName=" + oData.name + "')\">" + oData.name + "</a>");
                                    }
                                },
                                {
                                    data: 'from',
