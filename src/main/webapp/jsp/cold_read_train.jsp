<%
String page_title = "Cold Read Train";
%>
<%@ include file="header.jsp" %>
<%
ColdRead cold_read = ColdReadManager.getInstance().randomColdRead();
%>
<%@ include file="import_css.jsp" %>
<%@ include file="navbar.jsp" %>
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">Cold Read Train</h3>
    </div>
    <div class="panel-body">
        ...
        <div id="cold_read">
            <div class="well">
                <p><b><%=cold_read.name%></b></p>
                <p><i><%=cold_read.definition%></i></p>
                <p><i>Examples</i></p>
                <%
...
function stop() {
    ...
    $('#done_btn').click(function(){
        $.post(getAPIURL("api/cold_read/train"), { 'examples': $('#examples').val() }, function(data){
