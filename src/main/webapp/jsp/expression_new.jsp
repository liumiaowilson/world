<%
String page_title = "Expression New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <textarea class="form-control" id="keywords" rows="3" maxlength="200" placeholder="Enter keywords"></textarea>
    </fieldset>
    <fieldset class="form-group">
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/expression/create"), { name: $('#name').val(), 'keywords': keywords, 'content': $('#content').val() }, function(data) {
