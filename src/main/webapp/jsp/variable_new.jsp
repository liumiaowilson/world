<%
String page_title = "Variable New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <textarea class="form-control" id="expression" rows="5" maxlength="200" placeholder="Enter expression" required></textarea>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/variable/create"), { name: $('#name').val(), 'expression': $('#expression').val()}, function(data) {
