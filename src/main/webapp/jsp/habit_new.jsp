...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="number" class="form-control" id="interval" placeholder="Enter interval" value="1">
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/habit/create"), { name: $('#name').val(), 'description': description, 'interval': $('#interval').val()}, function(data) {
