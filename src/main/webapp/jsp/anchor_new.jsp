...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <textarea class="form-control" id="stimuli" rows="5" maxlength="200" placeholder="Enter stimuli"></textarea>
    </fieldset>
    <fieldset class="form-group">
        <label for="response">Response</label>
        <textarea class="form-control" id="response" rows="5" maxlength="200" placeholder="Enter response"></textarea>
    </fieldset>
    <div class="form-group">
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/anchor/create"), { name: $('#name').val(), 'stimuli': stimuli, 'type': $('#type').val(), 'response': $('#response').val() }, function(data) {
