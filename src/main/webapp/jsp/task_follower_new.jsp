<%
String page_title = "Task Follower New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="text" class="form-control" id="symbol" maxlength="20" placeholder="Enter symbol" required>
    </fieldset>
    <fieldset class="form-group">
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/task_follower/create"), { name: $('#name').val(), symbol: $('#symbol').val(), impl: $('#impl').val()}, function(data) {
