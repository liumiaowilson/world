...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="text" class="form-control" id="identifier" maxlength="50" placeholder="Enter identifier" required>
    </fieldset>
    <fieldset class="form-group">
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/account/create"), { name: $('#name').val(), 'description': description, 'identifier': $('#identifier').val(), 'amount': $('#amount').val()}, function(data) {
