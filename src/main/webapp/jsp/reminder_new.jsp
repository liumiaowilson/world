<%
String page_title = "Reminder New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <textarea class="form-control" id="message" rows="5" maxlength="200" placeholder="Enter message"></textarea>
    </fieldset>
    <fieldset class="form-group">
    ...
    <fieldset class="form-group">
        ...
        <input type="number" class="form-control" id="minutes" placeholder="Enter minutes" required>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/reminder/create"), { name: $('#name').val(), 'message': message, 'hours': $('#hours').val(), 'minutes': $('#minutes').val() }, function(data) {
