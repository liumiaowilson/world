...
<%
String page_title = "Local File Cached Edit";
%>
...
local_file = LocalFileManager.getInstance().getCachedLocalFiles().get(id);
if(local_file == null) {
    response.sendRedirect("local_file_cached_list.jsp");
    return;
}
%>
...
<script>
            ...
            function deleteLocalFile() {
                bootbox.confirm("Are you sure to delete this local file?", function(result){
                    if(result) {
                        var id = $('#id').val();
                        $.get(getAPIURL("api/local_file/delete_cache?id=" + id), function(data){
