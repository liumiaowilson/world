...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="number" class="form-control" id="severity" maxlength="20" placeholder="Enter severity" required>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/penalty/create"), { name: $('#name').val(), 'content': content, 'severity': $('#severity').val() }, function(data) {
