<%
String page_title = "Entity Def New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <div class="form-control" id="source" required><%=FormatUtils.escapeHtml(EntityDefManager.getInstance().getDefaultContent())%></div>
    </fieldset>
...
<script>
            ...
            source.getSession().setMode("ace/mode/json");
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        var def = source.getValue().replace(/&lt;/g, "<").replace(/&gt;/g, ">");
                        $.post(getAPIURL("api/entity_def/create"), { name: $('#name').val(), 'def': def}, function(data) {
