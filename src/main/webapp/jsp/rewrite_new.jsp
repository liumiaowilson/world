...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="text" class="form-control" id="fromUrl" maxlength="100" placeholder="Enter fromUrl" required>
    </fieldset>
    <fieldset class="form-group">
        <label for="toUrl">To Url</label>
        <input type="text" class="form-control" id="toUrl" maxlength="100" placeholder="Enter toUrl" required>
    </fieldset>
    <div class="form-group">
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/rewrite/create"), { name: $('#name').val(), 'regex': $("#regex").val(), fromUrl: $("#fromUrl").val(), toUrl: $("#toUrl").val() }, function(data) {
