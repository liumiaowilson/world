<%
String page_title = "Festival Data New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="text" class="form-control" id="definition" maxlength="50" placeholder="Enter definition" required>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/festival_data/create"), { name: $('#name').val(), 'description': description, 'definition': $('#definition').val()}, function(data) {
