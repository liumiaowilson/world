...
$(document).ready(function(){
    ...
    $('#save_btn').click(function(){
        ...
        if(action_name) {
            $.post(getAPIURL("api/extension_point/bind"), { 'ext_name': "<%=name%>", 'action_name': action_name }, function(data) {
            ...
            $.post(getAPIURL("api/extension_point/unbind"), { 'ext_name': "<%=name%>" }, function(data) {
                var status = data.result.status;
                var msg = data.result.message;
                if("OK" == status) {
                    showSuccess(msg);
