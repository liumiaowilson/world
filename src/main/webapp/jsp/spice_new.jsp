...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <textarea class="form-control" id="prerequisite" rows="2" maxlength="100" placeholder="Enter prerequisite"></textarea>
    </fieldset>
    <fieldset class="form-group">
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/spice/create"), { name: $('#name').val(), 'content': content, 'prerequisite': $('#prerequisite').val(), 'cost': $('#cost').val() }, function(data) {
