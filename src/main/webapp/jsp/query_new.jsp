...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="text" class="form-control" id="impl" maxlength="50" placeholder="Enter implementation" required>
    </fieldset>
    <fieldset class="form-group">
        <label for="idExpr">ID Cell Expression</label>
        <textarea class="form-control" id="idExpr" rows="5" maxlength="200" placeholder="Enter ID cell expression" required></textarea>
    </fieldset>
    <fieldset class="form-group">
        <label for="nameExpr">Name Cell Expression</label>
        <textarea class="form-control" id="nameExpr" rows="5" maxlength="200" placeholder="Enter name cell expression" required></textarea>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/query/create"), { name: $('#name').val(), impl: $('#impl').val(), idExpr: $('#idExpr').val(), nameExpr: $('#nameExpr').val()}, function(data) {
