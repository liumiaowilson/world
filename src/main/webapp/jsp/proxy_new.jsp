...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="text" class="form-control" id="host" maxlength="50" placeholder="Enter host" required>
    </fieldset>
    <fieldset class="form-group">
        <label for="port">Port</label>
        <input type="number" class="form-control" id="port" maxlength="20" placeholder="Enter port" required>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/proxy/create"), { name: $('#name').val(), 'description': description, 'host': $('#host').val(), 'port': $('#port').val() }, function(data) {
