<%
String page_title = "Java File Backup List";
%>
...
<script>
            $(document).ready(function(){
                $.get(getAPIURL("api/java_file/list_backup"), function(data){
                            ...
                            columns: [
                                {
                                    ...
                                    fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                                        $(nTd).html("<a href=\"javascript:jumpTo('java_file_backup_edit.jsp?id=" + oData.id + "')\">" + oData.id + "</a>");
                                    }
                                },
                                {
                                    data: 'name',
