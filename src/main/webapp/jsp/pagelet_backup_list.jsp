<%
String page_title = "Pagelet Backup List";
%>
...
<script>
            $(document).ready(function(){
                $.get(getAPIURL("api/pagelet/list_backup"), function(data){
                            ...
                            columns: [
                                {
                                    ...
                                    fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                                        $(nTd).html("<a href=\"javascript:jumpTo('pagelet_backup_edit.jsp?id=" + oData.id + "')\">" + oData.id + "</a>");
                                    }
                                },
                                {
                                    data: 'name',
