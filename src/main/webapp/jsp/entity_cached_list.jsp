...
String page_title = type + " Cached List";
%>
...
<script>
            $(document).ready(function(){
                $.get(getAPIURL("api/entity/list_cached?type=<%=type%>"), function(data){
                            ...
                            columns: [
                                {
                                    ...
                                    fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                                        $(nTd).html("<a href=\"javascript:jumpTo('entity_cached_edit.jsp?type=<%=type%>&id=" + oData.id + "')\">" + oData.id + "</a>");
                                    }
                                },
                                {
                                    data: 'name',
                            ...
                            buttons: [
                                {
                                    ...
                                    action: function (e, dt, node, config) {
                                        $.get(getAPIURL("api/entity/clear_cache?type=<%=type%>"), function(data){
                                            var status = data.result.status;
