...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <textarea class="form-control" id="question" rows="5" maxlength="200" placeholder="Enter question" required></textarea>
    </fieldset>
    <fieldset class="form-group">
        <label for="answer">Answer</label>
        <textarea class="form-control" id="answer" rows="5" maxlength="200" placeholder="Enter answer" required></textarea>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/faq/create"), { name: $('#name').val(), 'question': $('#question').val(), 'answer': $('#answer').val()}, function(data) {
