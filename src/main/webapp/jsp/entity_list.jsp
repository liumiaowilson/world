...
<script>
            $(document).ready(function(){
                $.get(getAPIURL("api/entity/list?type=<%=type%>"), function(data){
                            ...
                            columns: [
                                {
                                    ...
                                    fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                                        $(nTd).html("<a href=\"javascript:jumpTo('entity_edit.jsp?type=<%=type%>&id=" + oData.id + "')\">" + oData.id + "</a>");
                                    }
                                },
                                {
                                    data: 'name',
