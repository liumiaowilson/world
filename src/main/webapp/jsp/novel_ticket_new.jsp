<%
String page_title = "Novel Ticket New";
%>
...
<form id="form" data-toggle="validator" role="form">
    <fieldset class="form-group">
        ...
        <input type="text" class="form-control" id="docId" maxlength="100" placeholder="Enter docId" required>
    </fieldset>
    <fieldset class="form-group">
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/novel_ticket/create"), { name: $('#name').val(), 'description': description, 'docId': $('#docId').val() }, function(data) {
