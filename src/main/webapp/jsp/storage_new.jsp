...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="text" class="form-control" id="url" maxlength="50" placeholder="Enter url" required>
    </fieldset>
    <fieldset class="form-group">
        <label for="key">Key</label>
        <input type="text" class="form-control" id="key" maxlength="20" placeholder="Enter key" required>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/storage/create"), { name: $('#name').val(), 'description': description, 'url': $('#url').val(), 'key': $('#key').val() }, function(data) {
