...
<script>
            $(document).ready(function(){
                $.get(getAPIURL("api/query/list"), function(data){
                            ...
                            columns: [
                                {
                                    ...
                                    fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                                        $(nTd).html("<a href=\"javascript:jumpTo('query_edit.jsp?id=" + oData.id + "')\">" + oData.id + "</a>");
                                    }
                                },
                                {
                                    data: 'name',
                            ...
                            buttons: [
                                {
                                    ...
                                    action: function (e, dt, node, config) {
                                        jumpTo("query_new.jsp");
                                    }
                                },
                                {
                                    text: 'Processor',
                                    action: function (e, dt, node, config) {
                                        jumpTo("query_processor.jsp");
                                    }
                                }
                            ]
                        });
