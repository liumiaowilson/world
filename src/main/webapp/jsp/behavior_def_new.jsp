<%
String page_title = "Behavior Def New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="number" class="form-control" id="karma" maxlength="20" placeholder="Enter karma" required>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/behavior_def/create"), { name: $('#name').val(), 'description': description, 'karma': $('#karma').val() }, function(data) {
