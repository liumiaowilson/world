<%
String page_title = "Document New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <textarea class="form-control" id="content" rows="5" maxlength="200" placeholder="Enter content"></textarea>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/document/create"), { name: $('#name').val(), 'content': content}, function(data) {
