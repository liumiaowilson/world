<%
String page_title = "Bookmark New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="text" class="form-control" id="group" maxlength="20" placeholder="Enter group" required>
    </fieldset>
    <fieldset class="form-group">
    ...
    <fieldset class="form-group">
        ...
        <input type="text" class="form-control" id="url" maxlength="200" placeholder="Enter url" required>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/bookmark/create"), { name: $('#name').val(), 'content': content, 'group': $('#group').val(), 'url': $('#url').val() }, function(data) {
