<%
String page_title = "Quest Def New";
%>
...
<form id="form" data-toggle="validator" role="form">
    ...
    <fieldset class="form-group">
        ...
        <input type="number" class="form-control" id="pay" maxlength="20" placeholder="Enter pay" required>
    </fieldset>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post(getAPIURL("api/quest_def/create"), { name: $('#name').val(), 'content': content, 'pay': $('#pay').val()}, function(data) {
