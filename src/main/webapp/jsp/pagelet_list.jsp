<%
String page_title = "Pagelet List";
%>
...
<script>
            $(document).ready(function(){
                $.get(getAPIURL("api/pagelet/list"), function(data){
                            ...
                            columns: [
                                {
                                    ...
                                    fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                                        $(nTd).html("<a href=\"javascript:jumpTo('pagelet_edit.jsp?id=" + oData.id + "')\">" + oData.id + "</a>");
                                    }
                                },
                                {
                                    data: 'name',
