<%
String page_title = "Pagelet Backup Edit";
%>
...
pagelet = PageletManager.getInstance().getBackupPagelets().get(id);
if(pagelet == null) {
    response.sendRedirect("pagelet_backup_list.jsp");
    return;
}
%>
    ...
    <div class="form-group">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><a href="javascript:void(0)" onclick="restorePagelet()">Restore</a></li>
            </ul>
        </div>
    </div>
</form>
...
<script>
            ...
            function restorePagelet() {
                bootbox.confirm("Are you sure to restore this pagelet?", function(result){
                    if(result) {
                        var id = $('#id').val();
                        $.get(getAPIURL("api/pagelet/restore_backup?id=" + id), function(data){
