...
//Global options
var path_to_folder = '/Upload/svgavatars/',//the path to main SVG Avatars folder from root dir of your site. The slashes "/" are important!
	...
	hide_svg_download_on_Android = false, //true will disable download SVG option on Android devices (not useful)
	hide_svg_download = false, //true will disable download SVG option
...
var	hide_share = false, //true will disable share option
	...
	facebook_app_id = '683838944969771', //you must have an Facebook's App ID for correct work of share function (https://developers.facebook.com/apps)
	...
	share_description = 'Create an Avatar with Cardinali Designs!', //if you leave it blank, it might be taken from your meta description tag
	share_credit = 'Created on CardinaliDesigns.com';//replase YourSite.com with yours or leave it blank (do NOT delete variable itself!), if you don't want a watermark on avatar for Social share
