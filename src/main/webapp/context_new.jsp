<%
String from_url = "context_new.jsp";
%>
            ...
            $(document).ready(function(){
                ...
                $('#form').validator().on('submit', function (e) {
                    if (e.isDefaultPrevented()) {
                        ...
                        $.post("api/context/create", { name: $('#name').val(), 'description': description, 'color': $('#color').val()}, function(data) {
                            ...
                            if("OK" == status) {
                                ...
                                if("true" == flag) {
                                    ...
                                    l.ladda('stop');
                                    window.location.href = "context_list.jsp";
                                }
                            }
                            else {
                                showDanger(msg);
